package id.co.mondo.myworkmanager
...
class MyWorker(context: Context, workerParams: WorkerParameters): Worker(context, workerParams) {
    ...
    companion object{
        ...
        const val APP_ID = "d4119d77138ae6a39bb1b7b0997376b3"
        const val EXTRA_CITY ="city"
        const val NOTIFICATION_ID = 1
        const val CHANNEL_ID = "channel_01"
        const val CHANNEL_NAME = "mondo channel"
    }
    ...
    private fun getCurrentWeather(city: String?): Result {
        ...
        val url = "https://api.openweathermap.org/data/2.5/weather?q=$city,uk&APPID=$APP_ID"
